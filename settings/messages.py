...
#
# Message text for settings groups and buttons
#

from icons import *

BACK = "↩︎ Назад"
TEXT_UNKNOWN = "☠️ Здесь пока пусто..."
...
TEXT_CRYSTALS_RANGES   = "📊 Настройки вариантов ответа."
...
BUTTON_STATISTIC_NOMINATIONS = ICON_NOMINATE+" Номинации"
TEXT_STATISTIC_NOMINATIONS   = ICON_NOMINATE+" Настройки количества игроков-победителей."

BUTTON_STATISTIC_CYCLETIME   = "🔄 Цикличность"
TEXT_STATISTIC_CYCLETIME     = "🔄 Настройки длины цикла статистики для обновления номинантов и размера истории ВГ."
